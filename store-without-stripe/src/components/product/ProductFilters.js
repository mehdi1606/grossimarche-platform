      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          {categories.map((c) => (
            ...
            >
              <span className="grid h-7 w-7 shrink-0 place-items-center overflow-hidden rounded-md bg-emerald-50 text-emerald-600">
                <CategoryVisual image={c.imageUrl} icon={c.icon} className="h-4 w-4" />
              </span>
