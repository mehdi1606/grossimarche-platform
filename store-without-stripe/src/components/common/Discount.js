    ...
    <>
      {discount > 1 && (
        <span
          className={
            modal
              ? "absolute text-dark text-sm bg-orange-500 text-white py-1 px-2 rounded font-medium z-10 start-4 top-4"
              : slug
              ? "text-dark text-sm bg-orange-500 text-white py-1 px-2 rounded font-medium z-10 start-0 top-4"
        ...
        <span
          className={
            modal
              ...
              : slug
              ? "text-dark text-sm bg-orange-500 text-white py-1 px-2 rounded font-medium z-10 start-0 top-4"
              : "absolute text-dark text-xs bg-orange-500 text-white py-1 px-2 rounded font-medium z-10 end-0 top-0"
          }
        >
