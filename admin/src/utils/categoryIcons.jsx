...
/**
 * Premium line-icon set for product categories (Tabler icons). The category `icon` column
 * stores the short KEY (e.g. "oil"); the storefront renders the same catalogue. Keep this in
 * sync with `store-without-stripe/src/components/category/CategoryIcon.js`.
 */
...
// Older categories stored a keyword or an emoji instead of a catalogue key.
const ALIASES = {
  grain: "rice",
  cereal: "rice",
  cereals: "rice",
